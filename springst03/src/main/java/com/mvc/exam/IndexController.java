...
@Controller // 사용자의 명령을 입력 받아 매핑되는 메소드를 실행하는 클래스  mapping value가 겹치면 안된다. method 겹치면 안된
public class IndexController {
	...
	public ModelAndView index(ModelAndView modelAndView) {
		...
		modelAndView.addObject("myMessage","spring첫 테스트"); // setAttribute와 비슷하게 생각하면 된다.
